...
M1.5 is accepted in `main` at `0ebccf8da5e08fe18079e5d59477f33a956ae88b`, with exact-main Foundation CI green. M2.1 is implemented on `m2-1-official-source-scope-foundation` pending full validation, exact-commit CI, review, and merge. It establishes immutable official-source provenance and the national NextGen scope perimeter only; it does not begin Rule Obligations, doctrine/compiler, production curriculum/assessment, learner evidence, or AI. Apple enrollment/signing, physical-device authentication/SecureStore, live OS association routing, store ownership/approval, and native production purchase/restore remain mandatory at the applicable Native GA and are not marked verified.
