...
- Added an immutable/versioned Civil Procedure subject manifest tied to the exact current official scope, all six official subject leaves, and production coverage policy `BARCLIMB_CIVPRO_COVERAGE_POLICY@2026_V1`.
