...
M2.2b is accepted in `main` at `2b042d158bb68307a0af223acec1542b62702d20`, with exact-main Foundation CI green. M2.2c is active on `m2-2c-civpro-subject-foundation`. V1's six-leaf/18-requirement/75-slot plan was **REJECTED — REVISION REQUIRED** and is preserved as immutable history. V2 binds 27 exact official Civil Procedure terminal topics to six explicitly non-authoritative planning aggregates, 43 corrected requirements, 157 typed slots, 22 requirement-sensitive authority plans, and the noncircular terminal-topic certification gate. The immutable Rule 4 pilot remains only `PILOT_ONLY` partial/supplemental evidence. No new substantive obligations or subject certification exist; `subject_complete` and `national_complete` remain false. Read `docs/project/CURRICULUM_COVERAGE.md`, `M2_2C_HUMAN_REVIEW_PACKET_V1.md`, `M2_2C_V1_REVIEW_DISPOSITION.json`, and the active `M2_2C_HUMAN_REVIEW_PACKET.md`. V2 is `SECOND_REVIEW_PENDING`; finish validation/CI and stop for qualified human review before approval, merge, or any substantive Civil Procedure candidate compilation. Apple enrollment/signing, physical-device authentication/SecureStore, live OS association routing, store ownership/approval, and native production purchase/restore remain mandatory at the applicable Native GA and are not marked verified.
